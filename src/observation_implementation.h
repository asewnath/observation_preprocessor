...
namespace obs{
  ...
  class ObservationImpl{
   ...
   public:
     ...
     void output_data(OutputFormat format, const std::string& output_dir);
   ...
   protected: 
     ...
     std::string tablefn = "./src/prepobs_prep.bufrtable.eham";
     //std::string tablefn = "kma.bufrtable";
     long ndate = 0;
     std::vector<std::pair<std::string,std::vector<std::string>>> data_storage;

    private:
     void convert_to_prepbufr(const std::string& output_dir);
     void convert_to_textfile(const std::string& output_dir);
  ...
  class NOAAObservation: public ObservationImpl{
  ...
  class AVHRRObservation: public ObservationImpl{
  ...
  class KMAObservation: public ObservationImpl{
...
std::tuple<double, double> noaa_calculate_time(const std::string& old_time);
std::tuple<std::string, std::string>
